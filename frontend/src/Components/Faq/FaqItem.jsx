    ...
    <div className="p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] mb-5 cursor-pointer">
      ...
      >
        ...
        <div
          className={`${
            isOpen &&
            "bg-primaryColor text-white border border-solid border-[#D9DCE2] mb-5 cursor-pointer"
      ...
      {isOpen && (
        <div className="mt-4">
          <p className="text-[14px] leading-6 lg:text-[16px] lg:leading-6 font-[400] text-textColor">
            {item.content}
          </p>
        </div>
      )}
